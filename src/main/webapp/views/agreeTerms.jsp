...
<ul id="progressbar">
    ...
    <fieldset  = "form1">
    <h2 class="fs-title">Terms and Conitions</h2>
    <textarea rows="16" cols="50" disabled>
        1. YOUR AGREEMENT
...
Except our generated dummy copy, which is free to use for private and commercial use, all other text is copyrighted. generator.lorem-ipsum.info © 2013, all rights reserved
    ...
    <input type="checkbox" id="termsAgree" name="agree" value="agree" onchange="isChecked(this,'sub1')"/>I agree the Terms and Conditions.<br>
    <input type="button" name="previous" class="previous action-button" value="Previous" onclick="location.href='./createAccount'"/>
    <input type="button" name="next" class="next action-button" disabled="disabled" value="Next" id='sub1' onclick="location.href='./captcha'"/>
    <script>
    ...
    <script>
       function myFunction() {
        var x = document.getElementById("termsAgree").checked;
       }
