...
<div class="row">
    ...
    <div class="col-sm-8">
        <h3 style="display:inline">Add New Link</h3>
        <div class="pull-right">
            <input type="text" class="btn" style="border: 1px solid rgba(0,0,0,0.2);">
...
<script>
    ...
    links.forEach(function(item) {
		...
		add += '</span>';
		add += '<button type="button" class="btn btn-success pull-right" onclick="removeMe(' + item.id + ')">Add Link</button></p>';
        add += '<div class="extra" style="display: none;"><p>Age: Private</p><p>Address: Private</p><p>Phone: Private</p><p>Email: example@clc.ca</p></div>';
        add += '<hr/>';
		add += '</div>';
        temp.append(add);
    });
