...
<div class="row">
	<div class="col-sm-2">
		<a href="./home"><button id="backToLink" type="button" class="btn btn-primary">Back</button></a>
	</div>
	<div class="col-sm-8">
		<h3 style="display:inline;">Links</h3>
		<button id="search" type="button" class="btn btn-Primary pull-right">Add New User Link</button>
		<button id="pending" type="button" class="btn btn-Primary pull-right" style="margin-right: 20px;">View Pending Link(s)</button>
	</div>
<div class="row">
	<div class="col-sm-2"></div>
	<div class="col-sm-8" id="linkList"></div>
</div>
...
<script>
    ...
    links.forEach(function(item) {
        ...
        add += '<div class="extra" style="display: none;"><p>Age: 23</p><p>Address: 50 Stone Rd. E. Guelph, ON</p><p>Phone: (123) 456-7890</p><p>Email: example@clc.ca</p></div>';
        add += '<hr/>';
		add += '</div>';
        temp.append(add);
    });
    ...
    $('#pending').click(function (){
        location.href = "./pendingLinks";
    });

    $('#search').click(function(){
        location.href = "./searchLinks";
    });
</script>
